...
export default function App() {
  const [addedItems, setAddedItems] = useState([] || <h1>Hello</h1>); 
...
return (
   <> 
    ...
    <div className='flex flex-col md:flex-row justify-between gap-6 py-10 md:py-16 px-4 md:px-10 items-start'>
      <div>
        <h1 className="text-3xl md:text-5xl font-bold pb-10">Desserts</h1>
            ...
            return (
              <div key={food.id}>
                <img 
                  ...
                  style={{ height: "250px", width: "300px", margin:'auto' }} 
                  src={food.img} 
                  alt="" 
                />
      ...
      <div className='rounded-2xl white min-w-20 md:w-96'>
...
{/* The total price and confirm button */}
    ...
    <div>
      <button className={`${over ? 'active-modal' : ''}flex m-auto hover 
      button rounded-3xl mx-auto relative font-medium py-3 px-10 my-6 text-white`}
